...
class TrioStrats(MultiStrats) : 
    ...
    strats_str = {  
        ...
        'choix_des_2_a_4_meilleures_cotes' : 'choix des 2ème à 4ème meilleures_cotes',
        'choix_des_3_a_5_meilleures_cotes' : 'choix des 3ème à 5ème meilleures_cotes',
        'choix_des__N__a__Np3__meilleures_cotes' : 'choix des -N-ème à -Np3-ème meilleures_cotes',
        ...
        'choix_des_2_a_4_pires_cotes_inscrites' : 'choix des 2ème à 4ème pires cotes inscrites',
        'choix_des_2_a_4_pires_cotes_partantes' : 'choix des 2ème à 4ème pires cotes partantes',
        'choix_des__N__a__Np3__pires_cotes_inscrites' : 'choix des -N-ème à -Np3-ème pires cotes inscrites',
        'choix_des__N__a__Np3__pires_cotes_partantes' : 'choix des -N-ème à -Np3-ème pires cotes partantes',
    ...
    @change_repr
    def choix_des_2_a_4_meilleures_cotes(results, N=None, n=None, cote_type="direct") : 
        return MultiStrats.choix_des_N__meilleures_cotes(results, 1, 3, cote_type)

    @change_repr
    def choix_des_3_a_5_meilleures_cotes(results, N=None, n=None, cote_type="direct") : 
        return MultiStrats.choix_des_N__meilleures_cotes(results, 2, 3, cote_type)

    @change_repr
    def choix_des__N__a__Np3__meilleures_cotes(results, N=None, n=None, cote_type="direct") : 
    ...
    @change_repr
    def choix_des_2_a_4_pires_cotes_inscrites(results, N=None, n=None, cote_type="direct"):
        """chose the horse with 1st worst cote / last best cote"""
        return MultiStrats.choix_des__N__pires_cotes_inscrites(results, 1, 3, cote_type)

    @change_repr
    def choix_des_2_a_4_pires_cotes_partantes(results, N=None, n=None, cote_type="direct"):
        """chose the horse with 1st worst cote / last best cote"""
        raise NotImplementedError("NotImplementedError")

    @change_repr
    def choix_des__N__a__Np3__pires_cotes_inscrites(results, N=None, n=None, cote_type="direct") :
        """chose the horse with 1st worst cote / last best cote"""
        return MultiStrats.choix_des__N__pires_cotes_inscrites(results, N-1, 3, cote_type)

    @change_repr
    def choix_des__N__a__Np3__pires_cotes_partantes(results, N=None, n=None, cote_type="direct") :
        """chose the horse with 1st worst cote / last best cote"""
        raise NotImplementedError("NotImplementedError")
    ...
    def choix_aleatoire_3_parmi_les__N__meilleures_cotes(results, N, n=None, cote_type="direct") : 
        """chose the horse with best cote"""   
        return MultiStrats.choix_aleatoire_parmi_les__N__meilleures_cotes(results, N-1, 3, cote_type)
