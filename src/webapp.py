...
class App:
    ...
    bets    =  [   'simple_gagnant',   'simple_place', 'couple_gagnant',
                    'couple_place',     'couple_ordre', 'deux_sur_quatre',
                    'trio_ordre',       'trio_desordre','tierce_ordre',       
                    'tierce_desordre',  'quinte_ordre', 'quinte_desordre']


    strats =    {  'choix_de_la_meilleure_cote': Strats.choix_de_la_meilleure_cote,
